...
/* var modal_to_show=$.cookie('Modal_ID')==null ? 'cerulean' :$.cookie('Modal_ID');
  var Button_ID=$.cookie('Button_ID')==null ? 'cerulean' :$.cookie('Button_ID');
  ...
  $('#btn-setting2').click(function(e){
 	...
 	$('#btn-newquestion').click(function(e){
		e.preventDefault();
    $.cookie("Onclick_Button_ID","btn-newquestion");
    loadXMLDoc("?Step=Add_Stage1");
		$('#Modal1').modal('show');
	});  
  $('#btn-viewquestion').click(function(e){
		e.preventDefault();
    $.cookie("Onclick_Button_ID","btn-viewquestion");   
    loadXMLDoc("?Step=View_Question");
		$('#Modal1').modal('show');
	});
