            ...
            <div id="content" class="span10">
                ...
                <div>
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#">Score Statistic Analysis</a></li>
                    </ul>
                </div>
                <div class="control-group">
                    <label class="control-label" for="selectError">Semester Select</label>
                    <form action="ssa.php" method="post">
                        <div class="controls">
                            <select id="selectError" data-rel="chosen" name="select">
                                <option></option>
                                <option>2012 Spring</option>
                                <option>2012 Summer</option>
                                <option>2012 Autumn</option>
...
<?php header("content-type:text/html; charset=utf-8");
    ...
    if ($semester!=NULL){
        ...
        $sql = "select * from otstaketest where ots_Semester='$semester'";
        $result = mysql_db_query("SEproject", $sql, $conn);
        if (mysql_num_fields($result)){
            while ($row=mysql_fetch_row($result)){
                echo "<tr>";
                $paperid = $row[0];
                $courseid = mysql_fetch_row(mysql_db_query("SEproject", "select ots_CourseID from otstest where ots_PaperID='$paperid'", $conn))[0];
                $coursename = mysql_fetch_row(mysql_db_query("SEproject", "select cuz_name from imsCourse where cuz_id='$courseid'", $conn))[0];
                echo "<td>";
                echo $coursename;
                echo "</td>";
...
?>
        ...
        <p class="pull-left">&copy; 
            <a href="http://usman.it" target="_blank">Bao GG</a>2014
        </p>
        <p class="pull-right">Powered by: 
            <a href="http://usman.it/free-responsive-admin-template">Online Testing System</a>
        </p>
        </footer>
    </div>
    <!--/.fluid-container-->
