			...
			<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
				<div class="container">
                  ...
                  mysql_close($con);
			 			...
			 			<div class="row-fluid">
			 				...
			 				<?php
									...
									$colorflag=1;
									 ...
									 print("<tbody>\n");
									 $sql = "SELECT Re_imsCourse_acaClass_imsTeacher.cuz_id,cuz_name,class_id FROM Re_imsCourse_acaClass_imsTeacher,imsCourse WHERE is_graded=0 and teac_id=".$user_id." and Re_imsCourse_acaClass_imsTeacher.cuz_id=imsCourse.cuz_id" ;
									 $res = mysql_query($sql);
 							 ...
 							 ?>
							  <td>
							  	<button type="button" class="btn btn-default btn-sm"> Enter Course Grading</button>
							  </td>
					...
					<form id="clsform" name="clsform" action="sr_typein.php" method="post">
