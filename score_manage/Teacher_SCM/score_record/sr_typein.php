...
<!DOCTYPE HTML>
	...
	<html lang="en">
		...
		<body>
			...
			<form id="rcdform" action="sr_dbconnect.php" method="POST">
			 			...
			 			<div class="row-fluid">
			 				...
			 				<?php
									...
									$colorflag=1;
									 ...
									 print("<tbody>\n");
									 $sql = "SELECT studentid,student_name FROM smScore WHERE classid=".$_POST['clsid'];
									 $res = mysql_query($sql);
									 print("<input type='hidden' id='clsid' name='clsid' value='".$_POST['clsid']."'/>");
...

										{
										  ...
										  if($colorflag)
										   ...
										   print("</TD>");							 
							 			   print("<TD>");
							  			   print("<input max=100 min=0 name=".$Row["studentid"]." id=".$Row["studentid"]." type='number'/>");
							 			   print("</TD>");
									 ...
									 if($res)
									 print("<button type='button' class='btn btn-default btn-sm'> Submit Course Grading</button>");
									 else
