...
<!DOCTYPE HTML>
	...
	<html lang="en">
		...
		<body>
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav"> 
							...
							<li class="active">
								<a href="../score_modify/score_modify_app.php">Score Modify</a>
							</li>
						</ul>
			...
			<form id="moform" action="mo_dbconnect_2.php" method="POST">
			 			...
			 			<div class="row-fluid">
			 				...
			 				<?php
									...
									$colorflag=1;
									 ...
									 print("<thead><tr><th>Student ID</th><th>Name</th><th>Score</th><th>Modify to</th><th>Reason(less than 100 characters)</th></tr></thead>\n");
									 print("<tbody>\n");
...

										{
										  ...
										  if($colorflag)
										   ...
										   print("</TD>");
							 			   ...
							 			   print("<TD>");
							 			   	print("<input max=100 name=".$Row["studentid"]."_reason id=".$Row["studentid"]."_reason type='text'/>");
							 			   print("</TD>");
									 ...
									 if($res)
									 print("<button type='button' class='btn btn-default btn-sm'> Submit Modify Request</button>");
									 else
