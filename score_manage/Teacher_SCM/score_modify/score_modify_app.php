				...
				<div class="container">
					...
					<div class="collapse navbar-collapse">
						<ul class="nav navbar-nav"> 
							...
							<li  class="active">
								<a href="score_modify_app.php">Score Modify</a>
							</li>
						</ul>
			...
			<div class="container-fluid">
			 			<div class="row-fluid">
			 				...
			 				<?php
 							 ...
 							 ?>
							  <td>
							  	<button type="button" class="btn btn-default btn-sm">Apply for Modification</button>
							  </td>
					...
					<form id="clsform" name="clsform" action="mo_typein.php" method="post">
