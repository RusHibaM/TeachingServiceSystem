			 				...
			 				<?php
									...
									$colorflag=1;
									 ...
									 print("<tbody>\n");
									  ...
									  $sql = "SELECT Re_imsCourse_acaClass_imsTeacher.cuz_id,cuz_name,class_id FROM Re_imsCourse_acaClass_imsTeacher,imsCourse WHERE is_graded=1 and teac_id=".$user_id." and Re_imsCourse_acaClass_imsTeacher.cuz_id=imsCourse.cuz_id" ;
									 $res = mysql_query($sql);
