...
<html lang="zh-cn">
  ...
  <body>
    ...
    <a href="logout.php"><button id="logout" type="button" class="btn btn-success navbar-btn navbar-right">Log out</button></a> 
      <button  id="logout" class="btn navbar-btn navbar-right" ><?php echo $_SESSION["user_name"]; ?></button><!--User's name is here-->
				...
				<?php
					...
					else 
					{
						...
						if($_SESSION["view_type"]=="2")
						{
							 ...
							 {
								echo "<td>Cannot modify professional title</td>";
								echo "<td>Cannot modify professional title</td>";
							 }							
							 echo "</tr>";
							 ...
							 echo "<td><textarea name=\"Resume\" cols =\"50\" rows=\"5\"></textarea></td>";
